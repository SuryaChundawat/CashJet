...
import advice_natio.project.com.getmoney.Fragment.FavoritesFragment;
...
import advice_natio.project.com.getmoney.scrap.BottomBar;
...
public class Dashboard extends BaseActivity implements View.OnClickListener,NavigationView.OnNavigationItemSelectedListener, BottomNavigationView.OnNavigationItemSelectedListener,OnFragmentInteractionListener {
    ...
    private AppCompatTextView txtweeknumber,txtyear,txtname,txtirid,txtdate,txtavailablepoints,txtbuymore,txtencash;
    ...
    private void  getView() {
     ...
     //   OnNavigationItemSelectedListener
        ...
        toggle.syncState();
    /*    txtname =(AppCompatTextView) findViewById(R.id.txt_name);
        txtirid =(AppCompatTextView) findViewById(R.id.txt_irid);
        txtdate =(AppCompatTextView) findViewById(R.id.txt_date);
        txtweeknumber =(AppCompatTextView) findViewById(R.id.txt_weekNo);
        txtyear =(AppCompatTextView) findViewById(R.id.txt_year);
        txtavailablepoints =(AppCompatTextView) findViewById(R.id.txt_availblepoint);
        txtbuymore =(AppCompatTextView) findViewById(R.id.txt_buymore);
        txtencash =(AppCompatTextView) findViewById(R.id.txt_eacash);
        txtbuymore.setOnClickListener(this);
        txtencash.setOnClickListener(this);

        BottomBar bottomBar = (BottomBar) findViewById(R.id.bottomBar);
        circleImageView=(CircleImageView) findViewById(R.id.Image_view);*/
    }
